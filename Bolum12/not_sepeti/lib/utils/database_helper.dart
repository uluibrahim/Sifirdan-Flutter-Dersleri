...
class DatabaseHelper {
  ...
  //KATEGORİ TABLOSU İLE İLGİLİ CRUD İŞLEMLER
  Future<List<Map<String, dynamic>>> kategoriTablosunuGetir() async {
  ...
  Future<List<Kategori>> kategoriListesiniGetir() async {
    List<Map<String, dynamic>> kategoriIcerenMapListesi =
        await kategoriTablosunuGetir();
    List<Kategori> kategoriListesi = [];
    for (Map<String, dynamic> map in kategoriIcerenMapListesi) {
  ...
  Future<int> tumKategoriTablosunuSil(int kategoriID) async {
    var db = await _getDatabase();
    var sonuc = await db.delete("kategori");
    return sonuc;
  }

  //NOT TABLOSU İLE İLGİLİ CRUD İŞLEMLER

  Future<List<Map<String, dynamic>>> notTablosunuGetir() async {
    var db = await _getDatabase();
  ...
  Future<List<Not>> notListesiniGetir() async {
    ...
    List<Not> notListesi = [];
    for (Map<String, dynamic> gelenMap in notlarMapListesi) {
      notListesi.add(Not.fromMap(gelenMap));
    }
  ...
  Future<int> tumNotTablosunuSil(int kategoriID) async {
    var db = await _getDatabase();
